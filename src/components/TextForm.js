...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className="container my-3" style={{color: props.mode === 'dark'?'white':'#042743', color: props.mode === 'dark'?'white':'#042743'}}>
        ...
        <h2>Preview</h2>
        <textarea name="" id="" value={text .length > 0? text : "Nothing to preview"} style={{width: '1280px', height: '200px', border: 'solid 1px smoke', backgroundColor: props.mode === 'dark'?'#13466e':'white', borderRadius: '4px'}}></textarea>
    </div>
    </>
  );
}
